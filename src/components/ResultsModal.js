...
function ResultsModal(props) {
    ...
    <Modal show={winner !== null}>
        ...
        <Modal.Body>{winner? 'Congratulations, you guessed the word correctly and saved the stickman :) Click below to play another round.' : 'Unfortunately, you lost the game. The correct word is ' + guessWord + '.Click below to play another round.'}</Modal.Body>
        <Modal.Footer>
